    ...
    <div className='flex mx-auto max-w-2xl shadow border-b'>
        <div className='px-8 py-8'>
            ...
            <div className='items-center justify-end h-14 w-full my-4 space-x-4'>
                <button className='rounded text-white font-semibold bg-green-400 hover:bg-green-700 py-2 px-4'>Save</button>
                <button className='rounded text-white font-semibold bg-red-400 hover:bg-red-700 py-2 px-4'>Clear</button>
            </div>
        </div>
    </div>
  )
